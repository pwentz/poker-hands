...
RSpec.describe Game do
  ...
  describe '#get_score' do
    it 'gets the score of the player number passed (starts at 1)' do
      expect(game.get_score(2)).to eq 0
    end
  end

  describe '#get_hands' do
    it 'gets the hand of the player number passed (starts at 1)' do
  ...
  describe '#increment_score' do
    it 'increments the score of the player number passed (starts at 1)' do
